      ...
      <Grid container spacing={2} mt={5} justifyContent="center" alignItems="flex-start">
        ...
        <Grid item md={7}>
          ...
          <Typography sx={{ fontFamily: 'Poppins', lineHeight: 1.8, mt: 1 }}>
            ...
            potential and are here to help you unlock it. As you embark on this educational voyage,
            remember that success is not a destination but a journey. It requires hard work,
            determination, and guidance. We are here to provide that guidance, but your commitment
            is the key. I encourage you to make the most of your time here, ask questions, seek
            help, and strive for excellence. With your dedication and our expertise, your goals are
            within reach. I look forward to witnessing your achievements and celebrating your
            success. Together, let&apos;s make your dreams a reality. Wishing you a successful and
